...
// Questions for TA:
// ask about helpers with checking next number input
// clarification on discardDraw
// clarify aliasing with cards
...
public interface PyramidSolitaireModel<K> {
   ...
   *                  or a full pyramid and draw pile cannot be dealt with the number
   *                  of given cards in deck
   *
   */
  ...
  /**
   * Returns the number of rows originally in the pyramid,
